...
import rigeldevsolutions.gestasso.modulelog.controller.repositories.LogDetailsRepo;
import rigeldevsolutions.gestasso.modulelog.controller.repositories.LogRepo;
...
import rigeldevsolutions.gestasso.sharedmodule.utilities.ObjectTypeUtils;
...
public class LogService implements ILogService
{
    ...
    private Page<ConnexionList> getConnexionList(List<String> actions, String connId, String key, Long userId, LocalDate debut, LocalDate fin, Pageable pageable)
    {
        ...
        Long assoId = jwtService.getJwtInfos().getAssoId();
        Long sectionId = jwtService.getJwtInfos().getSectionId();
        Page<ConnexionList> connexionPage = logRepo.getConnnexionLogs(actions, key,userId, debut, fin.plusDays(1), connId, assoId, sectionId,pageable);
