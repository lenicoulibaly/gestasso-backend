...
@Documented
@Constraint(validatedBy = {MontantMax.CoherentDatesValidatorOnCreate.class,
        MontantMax.CoherentDatesValidatorOnUpdate.class})
public @interface MontantMax
{
    ...
    class CoherentDatesValidatorOnCreate implements ConstraintValidator<MontantMax, CreateEcheanceDTO>
    {
        @Override
    ...
    @Component @RequiredArgsConstructor
    class CoherentDatesValidatorOnUpdate implements ConstraintValidator<MontantMax, UpdateEcheanceDTO>
    {
        @Override
